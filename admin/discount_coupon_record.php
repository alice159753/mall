<?php
    ...
    $myTemplate = new Template(TEMPLATE_DIR ."/discount_coupon_record.html");
    ...
    $total_count = $myDiscountCouponRecord->getCount($condition);
    ...
    // list
    $rows = $myDiscountCouponRecord->getPage("*", $page, $page_size, $condition ." ORDER BY ". str_replace("-", " ", $order));
