<?php
    ...
    $myTemplate = new Template(TEMPLATE_DIR ."/discount_coupon.html");
    ...
    $total_count = $myDiscountCoupon->getCount($condition);
    $total_page = $myDiscountCoupon->getPageCount($page_size, $condition);

    $total_page = ($total_page == 0) ? 1 : $total_page;
    $page = ($total_page < $page) ? $total_page : $page;

    // list
    $rows = $myDiscountCoupon->getPage("*", $page, $page_size, $condition ." ORDER BY ". str_replace("-", " ", $order));
