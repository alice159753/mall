<?php
    ...
    $myTemplate = new Template(TEMPLATE_DIR ."/specification.html");
    ...
    $total_count = $mySpecification->getCount($condition);
    $total_page = $mySpecification->getPageCount($page_size, $condition);

    $total_page = ($total_page == 0) ? 1 : $total_page;
    $page = ($total_page < $page) ? $total_page : $page;

    // list
    $rows = $mySpecification->getPage("*", $page, $page_size, $condition ." ORDER BY ". str_replace("-", " ", $order));
