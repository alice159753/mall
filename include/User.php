...
class User extends Table
{
       function User($myMySQL, $table = "user")
	   {
        ...
        function login($userRow)
        {
            ...
            $_SESSION['channel_id'] = isset($userRow['channel_id']) ? $userRow['channel_id'] : '1';
            $_SESSION['openid'] = isset($userRow['openid']) ? $userRow['openid'] : '';

            header('Location:index.php');
        }

        function loginajax($userRow)
        {
            //设置级别
            $this->setRank($userRow);
        ...
        function register($user, $login_type = 'weixin')
        {
            ...
            $userArray['channel_id'] = isset($_SESSION['channel_id']) ? $_SESSION['channel_id'] : 1;
